<header class="flex border-b mb-3 border-blue-400">
    <div class="h-8 mt-2 mb-4 ml-1 w-full flex items-end">
        <img src="/logo.png" alt="Collintra" class="h-6 inline" />
        <div class="text-gray-600 italic text-sm w-min inline-flex flex-col justify-end ml-1 mr-1 translate-y-3">v1.0</div>
    </div>
